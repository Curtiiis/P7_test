...
function displayPasswordValidity(element, regex) {
   (!regex(element.value))
      ? setError(element, `Le mot de passe doit contenir 8 caractères : 1 majuscule, 1 minscule, 1 chiffre, 1 caractère spécial.`)
      : setSuccess(element);
}
